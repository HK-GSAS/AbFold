...
from abfold.config import NUM_RES, NUM_EXTRA_SEQ, NUM_TEMPLATES, NUM_MSA_SEQ
from abfold.np import residue_constants as rc
...
def random_crop_to_size(
    ...
    protein["crop_start"] = protein["seq_length"].new_tensor(num_res_crop_start)
